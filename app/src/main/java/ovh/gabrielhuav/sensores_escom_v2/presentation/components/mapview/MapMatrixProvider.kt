...
class MapMatrixProvider {
    companion object {
        ...
        // Acceso al mapa Zacatenco
        val MAIN_TO_ZACATENCO_POSITION = Pair(11, 1)
        val ZACATENCO_TO_MAIN_POSITION = Pair(12, 10)
        val ZACATENCO_TO_LINDAVISTA_POSITION = Pair(17, 34)
        val LINDAVISTA_TO_ZACATENCO_POSITION = Pair(20, 20)
        ...
        fun getInitialPositionForMap(mapId: String): Pair<Int, Int> {
            return when (mapId) {
                ...
                MAP_ZACATENCO -> Pair(15, 15)  // Posición central en el mapa principal
                MAP_LINDAVISTA -> Pair(15, 15)  // Posición central en el mapa principal
